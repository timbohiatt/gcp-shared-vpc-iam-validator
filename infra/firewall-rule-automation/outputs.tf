...
output "tq" {
  value = {
    //_factory_rules_folder = module.vpc-trusted-internal-firewall.tq._factory_rules_folder
    _factory_rule_files = module.vpc-trusted-internal-firewall.tq._factory_rule_files
